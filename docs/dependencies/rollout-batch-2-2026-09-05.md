...
- **imgl:** [PR #2](https://github.com/autogrammar/imgl/pull/2) wymaga niezależnego zatwierdzenia ostatniego commita zgodnie z [regułą main-supervised-autonomy](https://github.com/autogrammar/imgl/rules/21952608). CI wystawia wymagany check `test`, który przechodzi tylko po sukcesie obu wersji Pythona. Dozwolona metoda scalenia to merge commit. Harmonogramy zaczną działać po scaleniu.
