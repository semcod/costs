...
**Generated on:** 2026-03-29T13:02:19.201959
**Total issues:** 43 active, 12 completed

---

## ✅ Completed Tasks

- [x] src/costs/calculator.py:6 - Relative import (level=1): '.models'
- [x] src/costs/calculator.py:7 - Relative import (level=1): '.git_parser'
- [x] src/costs/calculator.py:27 - String concatenation can be converted to f-string
- [x] src/costs/calculator.py:7 - Unused get_commit_diff imported from git_parser
- [x] src/costs/calculator.py:7 - Unused import: 'get_commit_diff'
- [x] src/costs/reports.py:477 - Relative import (level=1): '.git_parser'
- [x] src/costs/reports.py:68 - String concatenation can be converted to f-string
- [x] src/costs/reports.py:169 - String concatenation can be converted to f-string
- [x] src/costs/reports.py:170 - String concatenation can be converted to f-string
- [x] src/costs/reports.py:48 - Magic number: 30 - use named constant
- [x] src/costs/reports.py:100 - Magic number: 40 - use named constant
- [x] src/costs/reports.py:344 - Magic number: 50 - use named constant
...
- [ ] src/costs/reports/badge.py:81 - String concatenation can be converted to f-string
- [ ] src/costs/reports/badge.py:79 - String concatenation can be converted to f-string
...
- [ ] src/costs/reports/markdown.py:57 - Magic number: 40 - use named constant
- [ ] src/costs/reports/markdown.py:59 - Magic number: 14 - use named constant
- [ ] src/costs/reports/markdown.py:76 - Magic number: 30 - use named constant
